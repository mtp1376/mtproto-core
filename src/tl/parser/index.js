...
return result;
  ...
  [3693421433, function() {
const result = { _: 'mt_eitaa_updates_expire_token' };
return result;
  }],
  [2775325233, function() {
const result = { _: 'mt_eitaa_updates_token' };
result.token = this.string();
result.expire = this.int();
result.date = this.int();
return result;
  }],
  [3693421429, function() {
const result = { _: 'mt_eitaa_token_updating' };
return result;
  }],
  [3395406586, function() {
const result = { _: 'mt_adsOpenLinkAction' };
result.link = this.string();
return result;
  }],
  [2633272715, function() {
const result = { _: 'mt_adsOpenExternalLinkAction' };
result.link = this.string();
return result;
  }],
  [155099767, function() {
const result = { _: 'mt_adsIntentAction' };
result.uri = this.string();
return result;
  }],
  [3749727930, function() {
const result = { _: 'mt_adsAdPack' };
result.title = this.string();
result.ads = this.vector(this.predicate, false);
return result;
  }],
  [812057886, function() {
const result = { _: 'mt_undefined' };
result.flags = this.int();
result.pinnedBackground = !!(result.flags & 4);
result.muted = !!(result.flags & 8);
result.verified = !!(result.flags & 16);
result.expire = this.int();
result.type = this.int();
result.id = this.int();
result.action = this.predicate();
result.title = this.string();
result.badge = this.string();
result.message = this.string();
result.thumbs = this.vector(this.predicate, false);
result.unreadCount = this.int();
return result;
  }],
  [3089795052, function() {
const result = { _: 'mt_undefined' };
...
return result;
  ...
  [1635347945, function() {
const result = { _: 'mt_eitaaAppInfo' };
result.build_version = this.int();
...
result.sign = this.string();
return result;
  }],
  [1587643126, function() {
const result = { _: 'mt_account.noPassword' };
result.new_salt = this.bytes();
result.new_secure_salt = this.bytes();
...
if (result.flags & 536870912) result.live_msg_id = this.int();
return result;
  }],
  [399807445, function() {
...
result.schedule_period_foreground_ms = this.int();
result.schedule_period_background_ms = this.int();
result.schedule_period_background_delay_ms = this.int();
result.upload_chunk_size_kb = this.int();
result.download_chunk_size_kb = this.int();
return result;
  }],
  [2384074613, function() {
...
return result;
  ...
  [3392779335, function() {
const result = { _: 'account.password2' };
result.flags = this.int();
result.has_recovery = !!(result.flags & 1);
result.has_secure_values = !!(result.flags & 2);
result.current_salt = this.bytes();
result.new_salt = this.bytes();
result.new_secure_salt = this.bytes();
result.secure_random = this.bytes();
...
return result;
  ...
  [570402317, function() {
const result = { _: 'account.passwordInputSettingsLayer68' };
result.flags = this.int();
if (result.flags & 1) result.new_salt = this.bytes();
if (result.flags & 1) result.new_password_hash = this.bytes();
if (result.flags & 1) result.hint = this.string();
if (result.flags & 2) result.email = this.string();
if (result.flags & 4) result.new_secure_salt = this.bytes();
if (result.flags & 4) result.new_secure_secret = this.bytes();
if (result.flags & 4) result.new_secure_secret_id = this.long();
return result;
  }],
  [326715557, function() {
...
return result;
  ...
  [4230874556, function() {
const result = { _: 'chatInviteExportedLayer122' };
result.link = this.string();
return result;
  }],
  [1776236393, function() {
const result = { _: 'chatInviteEmptyLayer122' };
return result;
  }],
  [1516793212, function() {
...
return result;
  ...
  [3681875288, function() {
const result = { _: 'chatInviteLayer84' };
result.flags = this.int();
result.channel = !!(result.flags & 1);
result.broadcast = !!(result.flags & 2);
result.public = !!(result.flags & 4);
...
return result;
  ...
  [4268294541, function() {
const result = { _: 'channelAdminLogEventActionChangeTheme' };
result.prev_value = this.string();
result.new_value = this.string();
return result;
  }],
...
return result;
  ...
  [2059302893, function() {
const result = { _: 'eitaaObject' };
result.token = this.string();
result.imei = this.string();
result.packed_data = this.bytes();
result.layer = this.int();
return result;
  }],
  [1640969877, function() {
const result = { _: 'liveGetMedia' };
result.flags = this.int();
result.id = this.long();
result.access_hash = this.long();
return result;
...
return result;
  ...
  [3421780262, function() {
const result = { _: 'messageMediaLiveStream' };
result.flags = this.int();
result.from_self = !!(result.flags & 2);
result.id = this.long();
result.access_hash = this.long();
if (result.flags & 1) result.total_viewers = this.int();
result.state = this.predicate();
if (result.flags & 4) result.thumbs = this.vector(this.predicate);
return result;
  }],
  [3031520670, function() {
const result = { _: 'liveStreamStateInit' };
return result;
  }],
  [3143327221, function() {
const result = { _: 'liveStreamStateBroadcasting' };
result.flags = this.int();
result.paused = !!(result.flags & 1);
result.liveStream = this.predicate();
return result;
  }],
  [3092059563, function() {
const result = { _: 'liveStreamStateEnded' };
result.flags = this.int();
result.duration = this.int();
if (result.flags & 1) result.expire_date = this.int();
if (result.flags & 1) result.archive_link = this.string();
return result;
  }],
  [4241539502, function() {
const result = { _: 'liveStreamStateEnded2' };
result.flags = this.int();
result.duration = this.int();
if (result.flags & 1) result.expire_date = this.int();
if (result.flags & 1) result.archive_link = this.string();
if (result.flags & 1) result.archive_size = this.int();
return result;
  }],
  [765942443, function() {
const result = { _: 'liveStream' };
result.flags = this.int();
if (result.flags & 1) result.read_link = this.string();
if (result.flags & 2) result.write_link = this.string();
result.start_date = this.int();
return result;
  }],
  [2286657449, function() {
const result = { _: 'liveGetParticipants' };
result.id = this.long();
result.access_hash = this.long();
return result;
  }],
  [4075389952, function() {
const result = { _: 'liveParticipants' };
result.users = this.vector(this.predicate, false);
return result;
  }],
  [2465594555, function() {
const result = { _: 'adsInputAdsLocationRecommend' };
return result;
  }],
  [3956130371, function() {
const result = { _: 'adsInputAdsLocationChatMembers' };
result.peer = this.predicate();
return result;
  }],
  [3879753283, function() {
const result = { _: 'adsInputAdsLocationContacts' };
return result;
  }],
  [1557811792, function() {
const result = { _: 'adsInputAdsLocationTrends' };
result.groupTitle = this.string();
return result;
  }],
  [314488883, function() {
const result = { _: 'adsInputAdsLocationDialog' };
return result;
  }],
  [2668347120, function() {
const result = { _: 'statAd' };
result.id = this.int();
result.adsLocation = this.predicate();
return result;
  }],
  [1635347945, function() {
const result = { _: 'eitaaAppInfo' };
result.build_version = this.int();
result.device_model = this.string();
result.system_version = this.string();
result.app_version = this.string();
